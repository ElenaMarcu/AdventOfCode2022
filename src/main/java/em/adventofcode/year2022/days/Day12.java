...
import em.adventofcode.year2022.utils.Point;
...
public class Day12 extends MainDay {
  ...
  public Day12(String fileName) {
    MainDay.logger = Logger.getLogger(Day12.class.getName());
    MainDay.lines = UtilClass.readLines(fileName);
    initVars();
  }

  private void initVars() {
    chars = new char[MainDay.lines.size()][MainDay.lines.get(0).length()];
    startingPoints = new ArrayList<>();
    int i = 0;
    for (String line : MainDay.lines) {
